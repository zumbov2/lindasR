#' Predefined SPARQL queries for the LINDAS knowledge graph
#'
#' \code{lindas_queries} is a collection of SPARQL queries used internally by
#' the package.
#'
#' @format A named list containing SPARQL query strings.
#' @noRd
lindas_queries <- list(
  datasets = '
